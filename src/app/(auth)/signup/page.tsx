...
import { User, HardHat, Truck, MoveLeft } from "lucide-react";
...
export default function Home() {
  ...
  const roles = [
    {
      id: "constructor",
      title: "Constructor / Architect",
      description: "Design, plan, and execute construction projects with expertise and accuracy.",
      icon: HardHat,
    ...
    },
    {
      ...
      description: "Discover and purchase products and services from trusted suppliers and professionals.",
      icon: User,
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-slate-50 via-slate-100 to-slate-200">
      ...
      <div className="w-full max-w-4xl z-10">
        <div className="text-center mb-8">
          <div className="flex justify-start max-w-2xl mx-auto">
           <Link href='/' className="text-sm text-slate-600 hover:bg-slate-200 hover:text-amber-500 rounded-md p-2 gap-3 flex items-center justify-center"><MoveLeft/></Link>
           <Image src="/kvv-logo.png" alt="KVV Pro" width={42} height={42} />
          </div>
          <h1 className="text-3xl font-bold text-slate-900 mb-4">Welcome to ConstructKVV platform</h1>
          <p className="text-lg text-slate-600">Join our professional construction network</p>
        </div>
        <Card className="w-full max-w-2xl mx-auto shadow-xl bg-white/90 backdrop-blur-lg">
          <CardHeader className="text-center">
            <CardTitle className="text-2xl font-semibold">What name describes you best?</CardTitle>
              ...
              return (
                ...
                >
                  ...
                  <div className="flex-1 text-left">
                    ...
                    <p className="text-sm text-slate-600 break-words whitespace-normal">{role.description}</p>
                  </div>
                </Button>
              );
            })}
      ...
      <div className="flex flex-col items-center justify-center gap-2">
        ...
        <Link href="/signin" className="text-amber-500 hover:text-amber-400">Sign in</Link>
        <p className="text-sm text-slate-600">By signing up, you agree to our <Link href="/terms" className="text-amber-500 hover:text-amber-400">Terms of Service</Link> and <Link href="/privacy" className="text-amber-500 hover:text-amber-400">Privacy Policy</Link></p>
      </div>
    </div>
  );
}
