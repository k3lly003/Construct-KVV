...
export const constructorRegistrationSchema = baseRegistrationSchema.extend({
  ...
  specializations: z
    .string()
    .min(10, "Please describe your specializations (minimum 10 characters)"),
  yearsOfExperience: z
    .number()
...
export const architectRegistrationSchema = baseRegistrationSchema.extend({
  ...
  designSpecialty: z
    .string()
    .min(10, "Please describe your design specialty (minimum 10 characters)"),
...
export const supplierRegistrationSchema = baseRegistrationSchema.extend({
  ...
  shopImage: z.union([
    fileSchema,
    z.string().url("Shop image must be a valid URL"),
  ]),
  shopDescription: z
    .string()
    .min(10, "Please describe your shop (minimum 10 characters)"),
  documents: z.array(fileSchema).max(10, "Maximum 10 documents allowed"),
  taxId: z.string().min(2, "Tax ID is required"),
});

export type ConstructorRegistration = z.infer<
  typeof constructorRegistrationSchema
>;
