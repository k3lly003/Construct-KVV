...
const Page = () => {
  ...
  useEffect(() => {
    const fetchShopData = async () => {
      ...
      try {
        ...
        const shopData = response.data; // Use the .data property from the API response
        setShop({
          ...shopData,
  ...
  const handleApproveShop = async () => {
    ...
    try {
      ...
      await ShopService.approveShop(shop.id, authToken);
      toast.success('Shop approved successfully');
      setShop(prev => prev ? { ...prev, status: 'active' as const, isActive: true } : null);
    } catch (error) {
  ...
  const handleDeleteShop = async () => {
    ...
    if (confirm('Are you sure you want to delete this shop? This action cannot be undone.')) {
      try {
        ...
        await ShopService.deleteShop(shop.id, authToken);
                    ...
                    <div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                          ...
                          <p className="text-base">{shop.productCount}</p>
                        </div>
                      </div>
                    </div>
                  </div>
