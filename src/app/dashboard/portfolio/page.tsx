  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-mid font-semibold">Recent Portfolio</h2>
          <p className="text-small text-muted-foreground">Create and manage your recent work.</p>
        </div>
      ...
      {!role && (
        <Card className="w-full">
          ...
          <CardContent>
            <p className="text-small text-muted-foreground">Please log in.</p>
          </CardContent>
        </Card>
      )}
    </div>
