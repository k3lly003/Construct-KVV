...
export default function ContractorPortfolioList({ title, description }: Props) {
  ...
  async function saveEdit() {
    ...
    // Enforce a total payload cap (~350KB for all images in this edit)
    const combined = [...editPreviews, ...compressed];
    const MAX_TOTAL_BYTES = 350_000;
    const pruned: string[] = [];
    let total = 0;
