      ...
      <div className="flex justify-between items-center mb-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            View and check all orders registered on your platform and edit them if necessary.
            The changes will be notified to users through the user dashboard and email.
          </p>
        </div>
