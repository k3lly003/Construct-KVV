  ...
  return (
    <div className="space-y-3">
      ...
      <div className="flex gap-3 flex-wrap">
        ...
        >
          <span className="text-mid text-teal-400">📷</span>
          <span className="text-small text-teal-500 mt-1 text-center">Click to Upload</span>
          <input
            type="file"
            accept="image/*"
            multiple
        ...
        {images.map((img, idx) => (
          <div key={idx} className="relative group w-24 h-24 rounded-lg overflow-hidden border border-gray-200">
            ...
            >
              <span className="bg-white text-red-600 px-2 py-1 rounded text-small font-semibold">
                Remove
              </span>
            </button>
          </div>
