...
const Page = () => {
  ...
  useEffect(() => {
    if (!id) return;
    setLoading(true);
    serviceService.getServiceById(id as string)
      .then((data) => {
        setServiceData(data);
        setLoading(false);
      })
  ...
  useEffect(() => {
    if (serviceData && serviceData.category) {
      categoryService.getCategoryById(serviceData.category)
  ...
  console.log("FFFFFFFFFFFFFFF", serviceData.category)
            ...
            <div className="flex items-center gap-2 ml-auto">
              ...
              <Dialog open={shareOpen} onOpenChange={setShareOpen}>
                <DialogTrigger asChild>
                  <GenericButton variant="ghost" size="sm" className="gap-2" onClick={handleShareClick}>
                ...
                <DialogContent>
                  ...
                  <div className="flex flex-col items-start gap-4 mt-2">
                    <span className="text-sm text-gray-700">Share this page on:</span>
                    ...
                    <span className="text-xs text-gray-400 mt-2">Link copied! You can now paste it anywhere.</span>
                  </div>
                </DialogContent>
              </Dialog>
            </div>
              ...
              <CardContent className="p-6">
                <Tabs defaultValue="features" className="w-full">
                  <TabsList className="flex w-full rounded-lg overflow-hidden bg-gray-100">
                    <TabsTrigger value="features" className="flex-1 px-4 py-2 text-center font-medium transition-colors duration-200 hover:bg-gray-200 data-[state=active]:bg-white data-[state=active]:shadow-md data-[state=active]:text-black rounded-none">Features</TabsTrigger>
                    <TabsTrigger value="specifications" className="flex-1 px-4 py-2 text-center font-medium transition-colors duration-200 hover:bg-gray-200 data-[state=active]:bg-white data-[state=active]:shadow-md data-[state=active]:text-black rounded-none">Specifications</TabsTrigger>
                    <TabsTrigger value="warranty" className="flex-1 px-4 py-2 text-center font-medium transition-colors duration-200 hover:bg-gray-200 data-[state=active]:bg-white data-[state=active]:shadow-md data-[state=active]:text-black rounded-none">Warranty</TabsTrigger>
                  </TabsList>
                  ...
                  <TabsContent value="warranty" className="mt-6">
                    <div className="rounded-xl bg-amber-100 p-6 shadow-sm border border-amber-100">
                      ...
                      <div className="flex items-center gap-3 mb-2">
                        <span className="text-3xl font-bold text-amber-900">{serviceData.warranty.duration}</span>
                      ...
                      <div className="mt-4">
                        ...
                        <div className="space-y-2">
                          {((serviceData.warranty && serviceData.warranty.coverage) || []).map((item: string, index: number) => (
                            <div key={index} className="flex items-center gap-3 py-2 border-b last:border-b-0 border-amber-100">
                              <CheckCircle className="w-5 h-5 text-green-600 flex-shrink-0" />
