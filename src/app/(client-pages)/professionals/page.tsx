      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-title font-bold text-gray-900 mb-4">Approved Professionals</h2>
            <p className="text-mid text-gray-600 max-w-2xl mx-auto">Browse architects, contractors, technicians, and sellers</p>
          </div>
