          ...
          <div className="space-y-8">
              ...
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) =>
                    updateFormData({ openFloorPlan: checked })
                  }
                />
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <RadioGroup
                ...
                onValueChange={(value) =>
                  updateFormData({ kitchenStyle: value })
                }
                ...
                {[
                  ...
                  <Label
                    ...
                    className={`
                      ...
                      ${
                        formData.kitchenStyle === style.id
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="flex items-center justify-between space-x-4 p-4 border rounded-md">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) =>
                    updateFormData({ hasBasement: checked })
                  }
                />
              </div>
              ...
              <div className="flex items-center justify-between space-x-4 p-4 border rounded-md">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) =>
                    updateFormData({ hasHomeOffice: checked })
                  }
                />
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 pt-2">
                {[
                  ...
                  <div
                    key={room.id}
                    className="flex items-center space-x-3 p-3 border rounded-md hover:bg-accent/30 transition-colors"
                  >
                    <Checkbox
                      id={`room-${room.id}`}
    ...
    case "gem":
      return (
        ...
        >
          ...
          <path d="m12 22 4-13-8-6" />
          <path d="M12 22 8 9l8-6" />
          <path d="M2 9h20" />
        </svg>
      );
    default:
