    ...
    <div className="bg-white rounded-2xl overflow-hidden w-full max-w-xs">
      <div className="relative w-full h-72">
        ...
        <div className="absolute bottom-0 left-0 right-0 px-4 text-white">
          ...
          <p className="text-small mb-2 overflo">{title}</p>
        </div>
      </div>
      <div className="px-4 pb-3 bg-black">
        {/* <div className="flex items-center justify-between py-2">
          <div className="flex flex-col items-center">
             <div className="flex justify-center">
                 ...
                 <span className="text-small font-semibold text-gray-200">
                     {rating}
                 </span>
             </div>
             <span className="text-small text-gray-100 ml-1">Rating</span>
          </div>
          ...
          <div className="flex flex-col items-center">
             ...
             <span className="text-small text-gray-100 ml-1">Established</span>
          </div>
          <hr className="border-white border-1 h-5" />
          <div className="flex flex-col items-center">
             <div className="flex justify-center">
             ...
             <span className="text-small text-gray-100 ml-1">Location</span>
          </div>
        </div> */}
        <div className="flex space-x-2 items-center py-3">
          ...
          <GenericButton
            className="flex bg-black py-2 text-small flex-grow border border-amber-500 text-white hover:bg-amber-500 cursor-pointer focus:outline-none rounded-md"
