  ...
  return (
    <div className="bg-white py-8">
      ...
      <div className="text-2xl font-medium text-gray-900 mb-6 flex justify-between">
        <select value="" className='w-20 text-sm font-normal border rounded-md'>
          <option id="">Cable</option>
          <option id="">Architecture</option>
          <option id="">Accessories & parts</option>
          <option id="">Finifing</option>
          <option id="">Man power</option>
        </select>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {productData.map((product) => (
            <div key={product.name} className="relative hover:shadow-md transition-shadow duration-200 space-y-3 mb-5">
