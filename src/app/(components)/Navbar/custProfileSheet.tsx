      ...
      {openChangePassword && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40">
          <div className="bg-white rounded-lg p-6 min-w-[320px]">
            <h2 className="text-mid font-bold mb-4">Change Password</h2>
      ...
      <div className="lg:col-span-1">
          ...
          <div className="text-center">
            <div className="relative inline-block mb-6">
              {profilePic ? (
                ...
                <div
                  className="w-24 h-24 bg-gradient-to-r from-indigo-500 to-purple-600 rounded-full flex items-center justify-center text-white text-mid font-bold shadow-lg cursor-pointer"
                  onClick={handleAvatarClick}
                >
                  {initials}
                </div>
        ...
        <div className="bg-gradient-to-r from-amber-700 to-amber-200 rounded-2xl p-6 text-white shadow-xl">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h3 className="font-bold text-mid">Become a Proffessional</h3>
              <p className="text-white/80 text-small">
                Start your business journey
              </p>
            </div>
          </div>
          <p className="text-white/90 text-small mb-4">
